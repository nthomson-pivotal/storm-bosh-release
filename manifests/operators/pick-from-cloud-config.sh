...
# The base manifests/apache-storm.yml assumes that your `bosh cloud-config` contains
...
#
# Usage:
#   bosh deploy manifests/apache-storm.yml -o <(./manifests/operators/pick-from-cloud-config.sh)
